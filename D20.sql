...
from online_retail_covert t ) AS x
where dup_flag =1 )
 --- begin analyst 
...
customerid,
	amount,
	TO_CHAR(first_purchase_date, 'yyyy-mm') as cohort_date, --gan first_purchase_date vao cohort theo YYYY-MM
	invoicedate,
...
MIN(invoicedate) over(PARTITION BY customerid) as first_purchase_date , -- ngay mua hang dau tien
invoicedate --ngay mua hang hien tai
